...
`apps/knx-gui` only holds thin adapters (`plugins/catalog/service.py`, `plugins/project/service.py`)
plus the GUI-only runtime view (`knx_gui.types.Device`).
...
┌─────────────────────────────────────────────────────────────────┐
│                          CATALOG                                  │
│  xknxmono.catalog — SQLite (default: demo.xknxcatalog)            │
│                                                                    │
