"""Shared filter-box widget for the project trees (devices, group addresses, spaces).

Renders a full-width hint input followed by a small clear button, and returns the
(possibly cleared) filter text.
"""
