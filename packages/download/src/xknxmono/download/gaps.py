...
KNOWN_GAPS: dict[str, str] = {
    "LdCtrlClearLCFilterTable": (
        "clear the line coupler filter table - either the function-property "
        "variant (UseFunctionProp) or the memory variant writing LcFilterMemory "
        "with a router stop/start sequence (KNX Standard v3.0.0, 3/5/1 Resources). "
        "This is coupler-only and needs a router to validate against"
    ),
    "LdCtrlOnError": (
