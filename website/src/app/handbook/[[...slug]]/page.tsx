import { getPageImage, getPageMarkdownUrl, source } from "@/lib/source/handbook";
import {
  DocsBody,
  DocsDescription,
  DocsPage,
    ...
    <DocsPage toc={page.data.toc} full={page.data.full}>
      ...
      <div className="flex flex-row gap-2 items-center border-b pb-6">
        ...
        <ViewOptionsPopover
          ...
          githubUrl={`https://github.com/${gitConfig.user}/${gitConfig.repo}/blob/${gitConfig.branch}/content/handbook/${page.path}`}
        />
      </div>
      <DocsBody>
        <MDX
